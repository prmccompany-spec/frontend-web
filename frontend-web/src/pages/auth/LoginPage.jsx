        ...
        <div className="lp-card">
          ...
          {step === 'phone' ? (
            ...
            <form onSubmit={handleVerifyOtp} className="lp-form">
              <div className="lp-field">
                <label htmlFor="code" className="lp-label">OTP Code</label>
                <div className="lp-input-wrap">
                  <input
                    type="text"
                    inputMode="numeric"
              ...
              <button type="submit" className="lp-submit" disabled={loading || code.length < 4}>
                {loading ? <><span className="lp-spinner" /> Verifying…</> : 'Verify & Sign in'}
              </button>
              <button
                type="button"
